...
addEventListener('mousemove', function (event) {
  ...
  angle = Math.atan2(mouse.y, mouse.x); // console.log(angle)
});
...
function init() {
  ...
  for (var i = 0; i < particleCount; i++) {
    var x = center.x + i * Math.cos(Math.PI);
    var y = center.y + i * Math.sin(Math.PI);
...
function animate() {
  ...
  c.fillRect(0, 0, canvas.width, canvas.height); // c.fillText('HTML CANVAS BOILERPLATE', mouse.x, mouse.y,'blue')
